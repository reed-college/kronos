...
class TestEvent:
    ...
    class Test_validate_end_after_start:
        ...
        def setup_class(cls):
            ...
            cls.event1 = Event(
                'at home',
                dtparse('20160502 08:00:00 AM'),
                dtparse('20160502 10:00:00 AM'),
                pearson)
            # for tests where it doesn't matter if the field is a dtstart or
            # dtend
        ...
        def test_validator_rejects_start_after_end(self):
            ...
            try:
                ...
                raise AssertionError(
                    "Validator didn't throw an AssertionError after receiving a start after the event's end")
        ...
        def test_validator_rejects_integers(self):
            ...
            try:
                ...
                raise AssertionError(
                    "Validator did not throw an AssertionError or TypeError when receiving and integer")
        ...
        def test_validator_rejects_malformed_strings(self):
            ...
            try:
                ...
                raise AssertionError(
                    "Validator did not throw an Error when receiving a malformed string")
